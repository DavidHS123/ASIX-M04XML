    ...
    private async Task FinalitzarRuta()
    {
        ...
        if (ruta != null)
        {
            ...
            foreach (PuntRuta puntRuta in puntsRuta)
            {
                ...
                xml = xml + "<trackpoint>\r\n" + 
                "<cord>\r\n" +  
                "<lat>" + puntRuta.Latitud.ToString(nfi) + "</lat>\r\n" +
                "<long>" + puntRuta.Longitud.ToString(nfi) + "</long>\r\n" + 
                "<alt>" + puntRuta.Elevacio?.ToString(nfi) + "</alt>\r\n" +
                "</cord>\r\n" + 
                "<datahora>" + puntRuta.DataHora.ToString("yyyy-MM-ddTHH:mm:ssZ") + "</datahora>\r\n" +
                "</trackpoint>\r\n";
            }
            xml = xml + "</trackpoints>\r\n"; /*** AQUI HAS DE MODIFICAR EL CODI ***/
            ...
            foreach (PuntInteres puntInteres in puntsInteres)
            {
                ...
                xml = xml + "<pdi>\r\n" +
                "<nom>" + puntInteres.Nom + "</nom>\r\n" +
                "<cord>\r\n" +
                "<lat>" + puntInteres.Latitud.ToString(nfi) + "</lat>\r\n" +
                "<long>" + puntInteres.Longitud.ToString(nfi) + "</long>\r\n" +
                "<alt>" + puntInteres.Elevacio?.ToString(nfi) + "</alt>\r\n" +
                "</cord>\r\n" +
                "<datahora>" + puntInteres.DataHora.ToString("yyyy-MM-ddTHH:mm:ssZ") + "</datahora>\r\n" +
                "</pdi>\r\n";
            }
            xml = xml + "</puntsinteres>\r\n";/*** AQUI HAS DE MODIFICAR EL CODI ***/
