...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="factura">
        ...
        <div class="row">
            <div>
                ...
                <p>Las potencias maximas demandadas en e! Ultimo afio han sido 4,870 KW en P1 (punta) y 4,680 kW en P3 (valle).</p>
    ...
    <xsl:template match="dadesfactura">
        ...
        <div class="dadesFactura">
            ...
            <div class="importFactura">
                ...
                <xsl:template match="periodeconsum">
                    <p>Periodo de consumo: <xsl:value-of select="inici"/> a <xsl:value-of select="final"/> (31 días)</p>
                </xsl:template>
                <p>Fecha de cargo: 24 de julio de 2023</p>
            </div>
        </div>
    </xsl:template>
    ...
    <xsl:template match="dadesreceptor">
        <div class="dadesClients">
            <p>David Hidalgo Salinas</p>
            <p>Dolors Callol 5</p>
            <p>17400 Breda</p>
            <p>GERONA</p>
            <img src="barras.png" alt="barras" class="img"/>
        </div>
    </xsl:template>
